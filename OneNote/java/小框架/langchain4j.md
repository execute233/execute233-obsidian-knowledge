...
![Exported image](Exported%20image%2020260731092524-0.png)

userMessage可以很多，可以是文本，图片，视频，音频等，比如

![Exported image](Exported%20image%2020260731092527-1.png)

系统提示词SystemMessage  
需要在用户对话前带上系统消息

![Exported image](Exported%20image%2020260731092532-2.png)
...
![Exported image](Exported%20image%2020260731092533-3.png) ![Exported image](Exported%20image%2020260731092534-4.png)
...
![Exported image](Exported%20image%2020260731092536-5.png)

该方式牺牲了些灵活性  
会话记忆  
一种是存储在内存里的

![Exported image](Exported%20image%2020260731092538-6.png)
...
![Exported image](Exported%20image%2020260731092539-7.png)

就能按指定的结构返回  
有时无法生成准确的JSON，可以使用JSON Schema模式，比如

![Exported image](Exported%20image%2020260731092541-8.png)

RAG（基于信息检索技术和AI内容生成的混合架构，可解决模型时效性与幻觉问题）

![Exported image](Exported%20image%2020260731092546-9.png)

langchain4j提供了3中RAG实现方式  
极简版langchain4j-easy-rag  
该版本内嵌了Embedding模型

![Exported image](Exported%20image%2020260731092548-10.png)
...
![Exported image](Exported%20image%2020260731092549-11.png)

工具调用ToolCalling  
我们需要自己定义类，里面打相应的注解

![Exported image](Exported%20image%2020260731092551-12.png)

构造的时候就可以指定tool

![Exported image](Exported%20image%2020260731092552-13.png)
...
![Exported image](Exported%20image%2020260731092553-14.png)

拦截器(护轨 Guardrail)  
在请求AI前和收到AI响应后执行一些额外的操作  
下面是一个输入拦截器的例子

![Exported image](Exported%20image%2020260731092558-15.png)
...
![Exported image](Exported%20image%2020260731092603-16.png)
...
![Exported image](Exported%20image%2020260731092606-17.png)